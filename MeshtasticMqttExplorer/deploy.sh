...
ssh $server -t -p $port "cd /home/valentin/docker/meshtastic_mqtt_explorer/ && docker restart test-meshtastic_mqtt_explorer-1 && docker logs -f --tail 10 test-meshtastic_mqtt_explorer-1"