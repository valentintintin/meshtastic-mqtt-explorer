...
namespace Common.Migrations
{
    ...
    [Migration("20241210130430_WebhookMqttServerId")]
    partial class WebhookMqttServerId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Common.Context.Entities.Router.PacketActivity", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("ReceiverIds")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Common.Context.Entities.Router.PacketActivity", b =>
                {
                    b.HasOne("Common.Context.Entities.Router.NodeConfiguration", "NodeConfiguration")
