...
namespace Common.Migrations
{
    ...
    [Migration("20241130210745_UserLastConectionDate")]
    partial class UserLastConectionDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Common.Context.Entities.NodeConfiguration", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Common.Context.Entities.PacketActivity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("NodeConfigurationId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("NodeConfigurationId");

                    b.HasIndex("UpdatedAt");

                    b.ToTable("PacketActivities");
                });
            ...
            modelBuilder.Entity("Common.Context.Entities.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Common.Context.Entities.NodeConfiguration", b =>
                {
                    b.HasOne("Common.Context.Entities.Node", "Node")
                        .WithOne()
                        .HasForeignKey("Common.Context.Entities.NodeConfiguration", "NodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Common.Context.Entities.User", "User")
            ...
            modelBuilder.Entity("Common.Context.Entities.PacketActivity", b =>
                {
                    b.HasOne("Common.Context.Entities.NodeConfiguration", "NodeConfiguration")
                        .WithMany("PacketActivities")
                        .HasForeignKey("NodeConfigurationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("Common.Context.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
